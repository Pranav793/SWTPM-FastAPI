...
def get_shared_dir() -> Path:
    ...
    """
    # tpm_dir = anylog_params.get_value_if_available("!tpm_dir")
    #  utils_io.test_dir_exists()
...
def _check_api_connectivity(status: process_status, base_url: str = DEFAULT_API_URL, timeout: int = 5) -> Dict[str, Any]:
    """
...
def find_key_by_name(key_name: str, base_url: str = DEFAULT_API_URL) -> Dict[str, Any]:
    ...
    if not connectivity_result.get("success"):
        ...
        # reply = connectivity_result.get("error", "API connectivity check failed")
